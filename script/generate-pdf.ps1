...
$originalPath = Join-Path $projectRoot "index.html"
$outputPath = Join-Path $projectRoot "output-print.html"
$pdfPath = Join-Path $projectRoot "pdf\Tesina.pdf"
...
<div class="indice-pdf">
  ...
  <ul>
    ...
    <li><a><span>Musica - Il jazz e la Grande Depressione</span><span class="num">p. 15</span></a></li>
  </ul>
</div>
'@
